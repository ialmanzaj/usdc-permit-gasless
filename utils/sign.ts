...
export const doSign = async (signer: providers.JsonRpcSigner | SignerWithAddress | Wallet,  token: Contract, value: any,owner:string, spender: string, deadline: number, chainId: number): Promise<Signature | null> => {
